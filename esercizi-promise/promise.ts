...
let promise:Promise<number>=getRandomNumber01();
...
let promise_2:Promise<number>= getRandomNumber02();
...
function getUserList2(page:number=5): Promise<UserListResponse> {
